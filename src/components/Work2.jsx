...
const Work2 = () => {
    ...
    return (
        <div className="container mx-auto px-4 my-3 ">
            <div>
                <h2 className="font-bold text-3xl text-pink-600 text-center border-b-2">Works</h2>
                <p className="text-gray-500 text-center">Here are some of the projects I've worked on.</p>
